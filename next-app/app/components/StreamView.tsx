...
export default function StreamView({ creatorId }: { creatorId: string }) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white flex flex-col items-center px-6 pt-28 pb-12">
      <Appbar />
      {/* Header Row: Title + Share Button */}
      <div className="w-full max-w-5xl flex justify-between items-center mb-8 mt-6">
        <h2 className="text-2xl font-semibold">🎵 Song Voting Queue</h2>
        <button
          onClick={handleShare}
